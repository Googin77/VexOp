...
// Import the settings icon (faCog)
      ...
      <aside className="w-64 flex-shrink-0 bg-brand-dark text-white flex flex-col p-3">
        ...
        <nav className="flex-grow">
          ...
          <NavLink to="/client/metrics" className={navLinkClasses}>
           ...
           {/* --- THIS IS THE FIX --- */}
           {/* The className now correctly uses your navLinkClasses function. The Outlet component has also been moved from here to the main content area. */}
